	...
	<div class="panel panel-primary favoritelist" data-id="">
		...
		<div class="panel-body">
						...
						<div class="panel panel-info">
							<div class="panel-heading">
								<h4 class="panel-title">
									<a data-toggle="collapse" class="collapsed" data-parent="#favorites-accordion" href="#collapse{$favorite.idfavoritelist}"><span class="name">{$favorite.list}</span> <span class="icon"></span></a>
								</h4>
							</div>
			...
			{/foreach}
									...
									<div id="dummy-list" class="panel panel-info hidden">
										<div class="panel-heading">
											<h4 class="panel-title">
												<a data-toggle="collapse" class="collapsed" data-parent="#favorites-accordion" href="#collapse"><span class="name">Dummy</span> <span class="icon"></span></a>
											</h4>
										</div>
