<?php
	...
	if (!$_POST['name'] || !$_POST['price']  || !$_POST['stock'] || !$_POST['weight'] || !$_POST['description'])
	...
	//	$errors['photos'] = 'The product needs at least one photo';
...
*/
	...
	try {
		$product_id = createProduct($name, $price, $stock, $weight, $description, $categories);
